...
<body>
                    ...
                    <div class="grid-container">
                        ...
                        <div class = "summary">
                            ...
                            <h3><strong> BARANGAY CLEARANCE </strong></h3><br>
                            <br>
                            <br>
                            <form method="POST" id="combined_form">
                                ...
                                <br>
                                <br>
                                This is to CERTIFY that <?php echo $row['lastname'];','.$row['firstname']?>, <?php echo $age; ?> years old, <?php echo $row['civilstatus']; ?>, <?php echo $row['gender']; ?>, born <?php echo $row['dateofbirth']; ?>, at <?php echo $row['placeofbirth']; ?>, <?php echo $row['city_municipality']; ?> is a bonafide resident of <?php echo $row['barangay']; ?>, Barangay 8, Bacolod City, whose signiture, Community Tax Certificate No., place of issue appears below. <br>
                                <br>
