...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
        ...
        $purposeText = array(
            "Renewal of PWD ID" => "Renewal of PWD ID",
            "Renewal of Senior ID" => "Renewal of Senior ID",
            "Scholarship Requirement" => "Scholarship Requirement"
        );
        $purpose = isset($_GET['purpose']) ? $_GET['purpose'] : '';
        $certText = isset($purposeText[$purpose]) ? $purposeText[$purpose] : "Renewal of PWD ID";
        ?>
                        ...
                        <div class = "summary">
                            ...
                            <form method="POST" id="combined_form">
                                <div class="padform">
                                    ...
                                    <br>
                                    <br>
                                    This is to CERTIFY that <?php echo $row['firstname'] . ' ' . $row['lastname']; ?>, <?php echo $age; ?> years old, <?php echo $row['gender']; ?>, born <?php echo $row['dateofbirth']; ?>, is a resident of <?php echo $row['barangay']; ?>, Barangay 8, Bacolod City whose means of livelihood is barely enough to support the daily needs of their family and therefore considered as indigent. <br>
                                    <br>
