    ...
    ?>
                    ...
                    <div class="grid-container">
                        ...
                        <div class = "summary">
                            ...
                            <h3><strong> CERTIFICATION </strong></h3><br>
                            <br>
                            <br>
                            <form action="picon.php" method="POST" id="combined_form">
                                ...
                                <br>
                                <br>
                                This is to CERTIFY that (FIRST NAME) (LAST NAME), (CIVIL STATUS) of legal age is the cousin of (FIRST NAME) (LAST NAME) are both residents of (BARANGAY NAME) Barangay 8, Bacolod City. <br>
                                <br>
