                    ...
                    <div class="grid-container">
                        ...
                        <div class = "summary">
                            ...
                            <form action="picon.php" method="POST" id="combined_form">
                                ...
                                <br>
                                <br>
                                This is to CERTIFY that (FIRST NAME) (LAST NAME), (AGE) years old, (CIVIL STATUS), (GENDER), born on (BIRTH DATE) at (BIRTH PLACE) is a resident of (BARANGAY NAME) Barangay 8, Bacolod City, whose signature, Comumunity Tax Certificate No., place of issue appears below. <br>
                                <br>
