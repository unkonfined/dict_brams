    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
            ...
            $sql_update_personal = "UPDATE personal_information SET firstname = ?, middlename = ?, lastname = ?, 
                                    appellation = ?, placeofbirth = ?, dateofbirth = ?, 
            ...
            mysqli_stmt_bind_param($stmt_update_personal, "sssssssssssi", $_POST['first_name'], $_POST['middle_name'], $_POST['last_name'], 
                                    $_POST['appellation'], $_POST['place_of_birth'], $_POST['date_of_birth'], 
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="appellation" name="appellation">
                                                        ...
                                                        <option value="Mr." <?php if($row['appellation'] == 'Mr.') echo 'selected'; ?>>Mr.</option>
                                                        <option value="Mrs." <?php if($row['appellation'] == 'Mrs.') echo 'selected'; ?>>Mrs.</option>
                                                        <option value="Miss" <?php if($row['appellation'] == 'Miss') echo 'selected'; ?>>Miss</option>
                                                        <option value="Ms." <?php if($row['appellation'] == 'Ms.') echo 'selected'; ?>>Ms.</option>
                                                        <option value="Dr." <?php if($row['appellation'] == 'Dr.') echo 'selected'; ?>>Dr.</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div style="display: flex; justify-content: center;">
                                    <input type="submit" name="update" id="update" class="btn btn-primary" value="Update" style="width: 200px;">
                            </div>
                        </form>
                    </div>
                </div>
