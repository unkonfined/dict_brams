    ...
    ?>
                    ...
                    <div class="grid-container">
                        ...
                        <div class = "summary">
                            ...
                            <h3><strong> CERTIFICATE OF BUSINESS CLOSURE </strong></h3><br>
                            <br>
                            <br>
                            <form action="picon.php" method="POST" id="combined_form">
                                ...
                                <br>
                                <br>
                                This is to CERTIFY that (BUSINESS NAME) is owned and managed by (FIRST NAME) (LAST NAME), with the business adress at (BUSINESS ADDRESS) has already stopped its operation since the month of February year 2023 due to non-profit <br>
                                <br>
